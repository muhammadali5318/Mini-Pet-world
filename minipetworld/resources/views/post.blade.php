            ...
            <div class="row">
               ...
               <div class="col-lg-6 col-md-6">
                  <div class="product-details-content" style="background-color: #f7f7f7; border: 1px solid #dddddd; border-radius: 5px; padding:10px; ">
                    <h3 style="color: #7e4c4f;"><b>Pet Features</b></h3> <br>
                     <h4 style="color:black;"><b style="padding-right: 12%;">Phone No </b> {{$post->phone}}</h4><br>

                     <h5 style="color:black;">
                      
                        <b style="padding-right: 20%;"><a target="_blank" href="{{$post->location}}">Click To Know Location</a> </b>
                      </h5><br>
                      ...
                      <p><span style="padding-right: 21%;"><b>Pet Price</b></span>  Rs. {{$post->price}}</p><br> 
