      ...
      <div class="container-fluid">
          ...
          <div class="row">
             ...
             <div style="padding-left: 8%;" class="col-lg-6 col-md-6">
              ...
              <button style="margin: 3%; background-color: #7e4c4f; color: white; padding: 8px 43px 34px 45px; border: none; font-weight: bold; font-size: 16px; border-radius: 30px; cursor: pointer ;"  type="submit" class="btn btn-primary">Search</button>
            </form>
