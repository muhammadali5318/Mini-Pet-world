...
@section('content')
 ...
 <div class="breadcrumb-area pt-95 pb-95 bg-img" style="background-image:url('{{asset('assets/img/banner/banner-2.jpg')}}');">
    ...
    @endif
      ...
      <div  style="background-image:url('{{asset('assets/img/banner/x.jpg')}}'); border-top: 2px solid white ; " class="checkout-area pt-95 pb-70">
         <div class="container">
            <h3 style="color: white; font-size: 35px;" class="page-title">checkout</h3>
            <div class="row">
               <div class="col-lg-10">
                  <div class="checkout-wrapper"> 
                        ...
                        <div class="panel panel-default"> 
                           <div id="payment-1" class="panel-collapse collapse show">
                              <div style=" margin: 1px -300px 5px -97px;" class="panel-body">
                                 <div style="border: 5px solid #7e4c4f;"  class="billing-information-wrapper">
                                    ...
                                    <table class="table table-summary">
                                     ...
                                     <div class="card">
                                            <div class="card-header" id="heading-3">
                                                <h2 style="font-size: 32px !important; padding-top: 10px !important; " class="card-title">
