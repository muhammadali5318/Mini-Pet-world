...
<div class="page-heading">
 ...
 <form  action="posts/store" enctype="multipart/form-data" method="post">
  ...
  <div class="form-group">
    ...
    <input  type="text" class="form-control" required="" id="name" name="name" placeholder="Enter Pet Name">  
    </div>
    ...
    <div class="form-group">
        ...
        <input  type="text" class="form-control" required="" id="location" name="location" placeholder="Enter Your Location">  
    </div>
