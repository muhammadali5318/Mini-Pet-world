                                ...
                                <div class="col-md-12">
                                  ...
                                  <form action="relocation/store" enctype="multipart/form-data" method="post">
                                    ...
                                    <div class="form-group">
                                     ...
                                     <div class="form-group">
                                        <label for="city">Relocation or Care</label>
                                        <input type="text" class="form-control" required="" id="name" name="city"class="form-control" placeholder="Write Relocation or Care. According to your demand">
                                    </div>
