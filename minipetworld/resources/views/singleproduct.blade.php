               ...
               <div class="col-lg-6 col-md-6">
                  <div class="product-details-img">
                     ...
                     @php $images = \App\Image::where('product_id',$product->id)->get() @endphp
                      ...
                      <img  src="{{ asset('images/products/thumbnails/'. $img->name) }}" alt="">
          ...
          {{$product->description}}</p>
                     ...
                     <div class="product-list-action">
                        <div class="product-list-action-left">
                            ...
                            <button style="background-color: #7e4c4f; border-color: #7e4c4f; background-color: #7e4c4f; color: white; padding: 15px 45px 15px 45px; border: none; font-weight: bold; font-size: 16px; border-radius: 30px; cursor: pointer ;" type="submit"    class="btn-product btn-cart"><i class="ion-bag"></i> Add To Cart</button> 
